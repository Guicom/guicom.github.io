...
/**
 * Provides dynamic permissions for Block promotion entity of different types.
 *
 * @ingroup soc_blocks_promotion
 *
 */
class BlockPromotionEntityPermissions{
   ...
   *
   * @return array
   *   The BlockPromotionEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (BlockPromotionEntity::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\soc_blocks_promotion\Entity\BlockPromotionEntity $type
   *   The BlockPromotionEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(BlockPromotionEntity $type) {
    $type_id = $type->id();
